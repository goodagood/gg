...
(function() {
  var Promise, assert, async, bucket, build_new_folder, build_root_folder_and_save, check_delete_file, check_pattern, delete_all_file, delete_file, delete_path_uuid, folder_exists, fs, get_file_meta, get_file_meta_by_path, get_file_meta_by_uuid, get_file_uuid, get_folder_uuid, get_sorted_message_list_as_ul, is_folder_exists, make_folder_meta_file_s3key, make_promisified_s3folder, make_s3folder, myconfig, myutil, new_folder, p, path, peek_possible_exist_folder, retrieve_file_by_path_uuid, retrieve_file_meta, retrieve_file_meta_pu, retrieve_file_objs, retrieve_files_by_pattern, retrieve_first_file_obj, retrieve_folder, retrieve_folder_meta, retrieve_metas_by_pattern, retrieve_promisified_folder, s3file, s3file_type, stop, test_add_folder, test_get_file_meta_by_path, test_get_file_meta_by_uuid, test_init_home_folder_many, test_read_folder_meta, test_retrieve_a_css, u, _file_name_to_delete_, _test_delete_member_file, _test_folder_path;
