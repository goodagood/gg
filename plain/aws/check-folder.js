//
// The meta.files screwed to array by sorting bug.
// abc, tmpab, 0201, 2015
//
// .load this file into REPL for easy checking
//
...
// This is for uses in REPL, it set name in REPL to folder object:
...
// -- the following is for fast checkings --
...
//}
//
//function check_pattern(file_path){
//    var _path = file_path || 'abc/txt22';
//
//    var folder_path = path.dirname (_path);
//    var basename    = path.basename(_path);
//    p(folder_path, basename);
//    folder_module.retrieve_promisified_folder(folder_path).then(function(folder){
//        var uuid_list = folder.pattern_to_uuids(/funn.+/);
//        p(uuid_list);
//        stop();
//    });
//}
...
//        else {throw 'only one can get deleted';}
//    }).then(function(uuid){
//        p(uuid);
