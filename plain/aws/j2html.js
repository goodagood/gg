...
//     because it looks so stupid, it's example shows it.
//
...
// The test results shows a stupid.
function test_jjj2() {
  ...
  p('<h1>Escape Quotes Test</h1>\n'+ html);
  p('<h1>Escape HTML Test</h1>\n'+ html2);
    
}

if(require.main === module){
  //p( 'you can do checking here');
  test_jjj2();
}
