...
var File_name_extension_regex = /mp4|mpeg|avi/i;
 ...
 * This build up file object from _meta, and save it to folder.
 */
...
/*
 * Attempt to render file as single web page.
 * 2015 0918
 */
function render_video_web_page(meta, callback){
  //var fs = require("fs");
  //var handlebars = require("handlebars");
  var FileName = path.join(__dirname, "web-page.html");
  //p('FileName: ', FileName);

  fs.readFile(FileName, 'utf-8', function(err, tpl_text){
    if(err) return callback(err);
    //p(tpl_text.slice(0, 200));
...
// Tools
module.exports.render_video_web_page = render_video_web_page;
