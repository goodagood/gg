...
//Backbone.sync = function(method, model, options)  ... old
Backbone.old_sync = function(method, model, options) {
...
// hack the sync?
Backbone.mysync = function(method, model, options) {
  return Backbone.getSyncMethod(model).apply(this, [method, model, options]);
};
...
function ajaxUpdate(data, sucess, fail){
    success = success || function(){alert('success, ' + a + b + c)};
    fail    = fail    || function(){alert('fail, '    + a + b + c)};
...
function sync_fun(method, model, options) {
    var store = model.localStorage || model.collection.localStorage;
