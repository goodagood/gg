...
$(function(){
    ...
    function read_meta_ajax(json_data, options){
        ...
        var success = options.success || function(a,b,c){alert('success, ' + a + b + c)};
        var error   = options.error   || function(a,b,c){alert('error, '   + a + b + c)};
    ...
    window.fetch_file_list_json = function(callback){
        var url = "http://54.178.88.149:9090/test/file-meta-list-json";
