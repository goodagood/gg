...
function check_write(){
    p('sample info:', sample_info);
    fs.writeFile('./test-meta.json', JSON.stringify(sample_info), 'utf-8', function(err, what){
        p('err:');
        p(err);
        stop();
    });
...
// During dev., drop middle state into REPL, 2015 0912.
function drop_pf(o){
    var txt = "this\n is\n sample\n text\n2015\n0909";
    var cwd = 'abc/test';
    var name = 't0912.txt';
    ...
    pf.write_text_file(ometa, function(e,r){
